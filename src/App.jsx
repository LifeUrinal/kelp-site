...
export default function KelpLandingPage() {
  return (
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <button className="group flex items-center justify-center gap-2 rounded-2xl bg-[#073f35] px-7 py-4 text-base font-bold text-white shadow-lg shadow-emerald-950/15 transition hover:bg-[#0b5a4b]">
                List material
